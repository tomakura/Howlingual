...
const translations: Record<AppLanguage, Translations> = {
	ja: {
		...
		apiKeyWarning: "APIキーはバックエンド側のアプリ設定に保存されます。共有PCではOFF推奨。",
		clipboardOps: "選択文の置換",
		clipboardOpsDesc: "翻訳結果で選択中のテキストを置き換えます",
		clipboardOpsWarning: "置換時は一時的にクリップボードを書き換えます",
		clipboardOpsConfirmEnable: "選択文の置換を有効化しますか？置換時は一時的にクリップボードを書き換えます。",
		clipboardOpsConfirmReplace: "選択中のテキストを置換します。クリップボード内容が失われる可能性があります。続けますか？",
		clipboardOpsDisabled: "選択文の置換が無効です",
	...
	en: {
		...
		apiKeyWarning: "API keys are stored in the backend app settings. Turn off on shared machines.",
		clipboardOps: "Replace selection",
		clipboardOpsDesc: "Replace the selected text with a translation result",
		clipboardOpsWarning: "Replacement temporarily overwrites the clipboard",
		clipboardOpsConfirmEnable: "Enable selection replacement? Replacement temporarily overwrites the clipboard.",
		clipboardOpsConfirmReplace: "Replace the selected text? Clipboard contents may be lost.",
		clipboardOpsDisabled: "Selection replacement is disabled",
	...
	zh: {
		...
		apiKeyWarning: "API 密钥会保存在后端应用设置中，共享设备建议关闭。",
		clipboardOps: "替换选中文本",
		clipboardOpsDesc: "用翻译结果替换当前选中的文本",
		clipboardOpsWarning: "替换时会临时改写剪贴板",
		clipboardOpsConfirmEnable: "要启用替换选中文本吗？替换时会临时改写剪贴板。",
		clipboardOpsConfirmReplace: "要替换选中文本吗？剪贴板内容可能会丢失。",
		clipboardOpsDisabled: "替换选中文本已禁用",
	...
	ko: {
		...
		apiKeyWarning: "API 키는 백엔드 앱 설정에 저장됩니다. 공유 PC에서는 끄는 것을 권장합니다.",
		clipboardOps: "선택 문장 치환",
		clipboardOpsDesc: "번역 결과로 선택한 텍스트를 바꿉니다",
		clipboardOpsWarning: "치환 시 클립보드를 임시로 변경합니다",
		clipboardOpsConfirmEnable: "선택 문장 치환을 활성화할까요? 치환 시 클립보드를 임시로 변경합니다.",
		clipboardOpsConfirmReplace: "선택한 텍스트를 바꿀까요? 클립보드 내용이 사라질 수 있습니다.",
		clipboardOpsDisabled: "선택 문장 치환이 비활성화되었습니다",
